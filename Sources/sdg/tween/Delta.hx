...
import sdg.tween.easing.Linear;
import sdg.tween.tweens.FloatTween;
import sdg.tween.tweens.IndexTween;
import sdg.tween.tweens.FuncTween;
...
@:build(sdg.tween.actions.Inject.init())
class TweenAction {
